      ...
      try {
        ...
        if (data.success) {
          setSuccess({
            ...
            folioTickGenerado: folioTick // Mostramos el folio que se usó
          });
          
          // Limpiar los campos después del éxito, pero mantener el ID por si quieren hacer otro canje al mismo usuario
          setFormData(prev => ({
            ...prev,
            importe: "",
            folioTick: "",
